...
# Ensure both the participant and response queues are declared in the consumer as well
...
def on_message(ch, method, properties, body):
    try:
        ...
        # Log response from the endpoint and publish to response queue if successful
